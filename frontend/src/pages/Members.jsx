...
import kevinPhoto from '../assets/MUHAMMAD KEVIN ADLI PRATAMA.jpeg';

const Members = () => {
    const members = [
        { name: "MUHAMMAD FAWAZ SAPUTRA, S.T., M.ENG.", role: "Dosen Pembimbing", batch: "Advisor", status: "Aktif" },
        { name: "MUHAMMAD KEVIN ADLI PRATAMA", role: "Ketua Study Club", batch: "Angkatan 2023", status: "Aktif", photo: kevinPhoto },
